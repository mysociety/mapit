...
sudo -u deploy curl 'https://s3.amazonaws.com/gds-public-readable-tarballs/govuk-mapit/20160901-mapit.sql.gz' -o mapit.sql.gz
if ! echo "b7719244ea3d25564403dde3943d17b76474063b mapit.sql.gz" | sha1sum -c -; then
