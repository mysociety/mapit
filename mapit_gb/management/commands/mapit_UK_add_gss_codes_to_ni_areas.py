...
class Command(NoArgsCommand):
    ...
    def add_gss_code_to_eur_area(self):
        ...
        if euro_area:
            ...
            print 'WARNING: No EUR area with name "Northern Ireland" to add GSS code "N07000001" to'
    ...
    def update_lgds(self, districts):
        for district in districts:
            ...
            if lgd:
                ...
                print 'WARNING: No LGD with name "%s" to add GSS "%s" to' % (district_name, district_gss_code)
    ...
    def update_lges_for_lgd(self, electoral_areas, lgd):
        for electoral_area in electoral_areas:
            ...
            if lge:
                ...
                print ('WARNING: No LGE with name "%s" as child of LGD "%s" to '
    ...
    def update_lgws_for_lge(self, wards, lgd, lge):
        for ward in wards:
            ...
            if lgw:
                ...
                print ('WARNING: No LGW with name "%s" as child of LGE "%s" and'
