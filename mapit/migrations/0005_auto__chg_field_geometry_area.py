...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field areas on 'Geometry'
        db.create_table('mapit_geometry_areas', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('geometry', models.ForeignKey(orm['mapit.geometry'], null=False)),
            ('area', models.ForeignKey(orm['mapit.area'], null=False))
        ))
        db.create_unique('mapit_geometry_areas', ['geometry_id', 'area_id'])

        # Changing field 'Geometry.area'
        db.alter_column('mapit_geometry', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mapit.Area']))


    def backwards(self, orm):

        # Removing M2M table for field areas on 'Geometry'
        db.delete_table('mapit_geometry_areas')

        # Changing field 'Geometry.area'
        db.alter_column('mapit_geometry', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapit.Area']))
