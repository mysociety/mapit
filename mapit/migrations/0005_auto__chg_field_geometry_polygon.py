...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Geometry.polygon'
        db.alter_column(u'mapit_geometry', 'polygon', self.gf('django.contrib.gis.db.models.fields.PolygonField')())

    def backwards(self, orm):

        # Changing field 'Geometry.polygon'
        db.alter_column(u'mapit_geometry', 'polygon', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=4326))
