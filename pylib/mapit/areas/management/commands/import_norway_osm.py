...
# It takes KML data generated by bin/osm_to_kml_norway, so you should run that first.
#
...
class Command(LabelCommand):
    ...
    args = '<OSM KML files generated by osm_to_kml_norway (make sure fylke KML file is first)>'
